			...
			<div class="kt-card border border-border rounded-xl shadow-sm bg-card">
				...
				<div class="kt-card-body">
					...
					<div class="flex items-center gap-2 mt-4">
						...
						<input bind:value={editNote} placeholder="Catatan perubahan (opsional)" class="wt-input border border-input rounded-lg px-3 py-2 text-sm flex-1" />
					</div>
		...
		<div class="flex flex-col gap-5 lg:gap-7.5">
			...
			{#if ticket.status?.name !== 'Closed' && ticket.status?.name !== 'Rejected/Invalid'}
				<div class="kt-card border border-border rounded-xl shadow-sm bg-card">
					...
					<div class="kt-card-body">
						<div class="flex flex-col gap-3">
							<input bind:value={closeReason} placeholder="Alasan penutupan (opsional)" class="wt-input border border-input rounded-lg px-3 py-2 text-sm" />
